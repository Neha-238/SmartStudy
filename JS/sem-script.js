...
// // Define semesters for each course
// const semesters = {
//   mca: ["Semester 1", "Semester 2", "Semester 3", "Semester 4"],
//   mba: ["Semester 1", "Semester 2", "Semester 3", "Semester 4", "Semester5"],
// };

// // Render semesters dynamically
// semesters[course].forEach((sem, index) => {
//   const card = document.createElement("div");
//   card.className = "sem-card";
//   card.textContent = sem;
//   card.addEventListener("click", () => {
//     // Redirect to subject/material page for this semester
//     window.location.href = `subjects.html?course=${course}&sem=${index + 1}`;
//   });
//   semCardsContainer.appendChild(card);
// });

// // Change dropdown value if navigated from home page
...
//   chatPopup.classList.add("active"); // Open popup
// });
